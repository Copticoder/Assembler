class Code:
    ...
    """
    # The JUMP part codes
    jump_codes = {'':'000', 'JGT':'001', 'JEQ':'010', 'JGE':'011', 'JLT':'100', 'JNE':'101', 'JLE':'110', 'JMP':'111'}

    # The DEST part codes
    dest_codes = {'':'000', 'M':'001', 'D':'010', 'MD':'011', 'A':'100', 'AM':'101', 'AD':'110', 'AMD':'111'}
    ...
    def dest(self,mnemonic):
        if not mnemonic:
            return self.dest_codes[""] 
        return self.dest_codes[mnemonic]
    
    def jump(self,mnemonic):
        if not mnemonic:
            return self.jump_codes[""]
